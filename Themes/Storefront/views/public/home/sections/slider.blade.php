<section class="home-section-wrap">
    ...
    <div>
        <div class="row">
            <div class="home-section-inner" style="margin-left: 0px !important; width: 100% !important;">
                <div class="home-slider-wrap" style="width:100% !important;">
                    <div
                        class="home-slider"
              ...
              <?php /*  @include('public.home.sections.slider_banners') */ ?>
            </div>
        </div>
    </div>
</section>
